...
Kim, T.D., Pereira-Obilinovic, U., Wang, Y., Shea-Brown, E., Sümbül, U. (2026). Identifying Connectivity Distributions from Neural Dynamics Using Flows. [*Proceedings of the 43rd International Conference on Machine Learning (ICML)*](https://arxiv.org/abs/2603.26506).
