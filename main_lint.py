...
parser = argparse.ArgumentParser(
    description='Custom implementation of LINT (Valente et al., 2022)'
)
parser.add_argument(
...
parser.add_argument(
    ...
    help='dimensionality of the hidden layer (default: 1000)'
)
parser.add_argument(
...
parser.add_argument(
    '--standard_training_epochs', type=int, default=3000,
    help='number of standard training epochs (default: 3000)'
)
parser.add_argument(
